  ...
  <body>
	...
	<div class="container-fluid content">
		...
		<div class="row justify-content-center">
			<div class="col-sm-3 form-panel login">
				<h1>Create</h1>
				<div class="form-group">
					<form action="passwordReset" method="post">
						<div class="form-group">
							<label>Your email</label>
							<input type="email" name="email" class="form-control label" value="${recover}">
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<input type="password" name="confirm" class="form-control label" placeholder="Password">
						</div>
