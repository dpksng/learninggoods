...
<head>
	...
	<title>Forgot Password :: Learninggoods.com</title>
  ...
  <body>
	...
	<%@ include file ="header.jsp" %>	
		...
		<div class="row justify-content-center">
			<div class="col-sm-4 form-panel forgot">
				<h1>Your Email</h1>
				<div class="form-group">
					<form action="accountRecovery" method="post">
						...
						<button type="submit" class="btn cust-btn form-control label">CONTINUE</button>						
					</form>
				</div>
			</div>
		</div>
